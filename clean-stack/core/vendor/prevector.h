...
public:
    ...
    class reverse_iterator {
        T* ptr{}; // one-past-the-element (std::reverse_iterator-style base)
    public:
        typedef Diff difference_type;
        typedef T value_type;
        typedef T* pointer;
    ...
    class const_reverse_iterator {
        const T* ptr{}; // one-past-the-element (std::reverse_iterator-style base)
    public:
        typedef Diff difference_type;
        ...
        const_reverse_iterator(reverse_iterator x) : ptr(x.base()) {}
...
#pragma pack(pop)
    ...
    void change_capacity(size_type new_capacity) {
        if (new_capacity <= N) {
            ...
            if (!is_direct()) {
                /* FIX-ME: Because malloc/realloc here won't call new_handler if allocation fails, assert
...
public:
    ...
    reverse_iterator rbegin() { return reverse_iterator(item_ptr(size())); }
    const_reverse_iterator rbegin() const { return const_reverse_iterator(item_ptr(size())); }
    reverse_iterator rend() { return reverse_iterator(item_ptr(0)); }
    const_reverse_iterator rend() const { return const_reverse_iterator(item_ptr(0)); }
